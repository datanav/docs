...
.. admonition:: Prerequisits
  ...
  Before starting on this tutorial you should:

  - Have a general understanding of input pipes **link?** in Sesam.

  - Go through :ref:`Custom Data Source - The Microservice System <tutorial_custom_data_source_microservice>` as this current tutorial is heavily based the previous results. 

  - Read the section concerning :ref:`Continuation support for Microservices <continuation_support_microservices>` in our documentation. 
