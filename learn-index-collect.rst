...
.. admonition:: Prerequisites
	...
	In some of these tutorials we will use `HubSpot <https://www.hubspot.com/>`_ as a baseline. If you have not already created a HubSpot test account in :doc:`getting started <guide-getting-started>` we suggest you read the guide for :doc:`Create your first synchronization <guide-create-first-synchronization>` and create a HubSpot test account now.
