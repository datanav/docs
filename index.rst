...
.. panels::
    ...
    **Sesam Talk**
    ...
    Sesam Talk is a product that allows SaaS vendors to offer a solution for their tenants to synchronise their business data using a user-friendly interface. No setup nor developement needed.
