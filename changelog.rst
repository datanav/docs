...
* We automatically upgrade a *small* subscription type to a *medium* subscription type if the data storage usage exceeds 40 Gb. Note that this also affects self-hosted subscriptions.
