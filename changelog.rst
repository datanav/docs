...
2017-03-02
----------
* Added a :ref:`conditional source <conditional_source>` that can pick from a list of candidate actual sources, typically controlle by an environment variable.
