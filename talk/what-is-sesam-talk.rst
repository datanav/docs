...
Sesam Talk synchronizes a limited set of :doc:`core types <datatypes/index>` with a limited set of properties between the various :doc:`supported system <systems/index>`.
