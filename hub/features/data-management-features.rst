...
.. panels::
    ...
    **Automatic Reprocessing**
    ...
    .. link-button:: automatic_reprocessing
            :type: ref
            :text: Read more
            :classes: read-more
    ---
    ...
    **Dependency Tracking**
    ...
    .. link-button:: dependency_tracking
            :type: ref
            :text: Read more
            :classes: read-more
    ---
    ...
    **Compaction**
    ...
    .. link-button:: compaction-feature
            :type: ref
            :text: Read more
            :classes: read-more
    ---
