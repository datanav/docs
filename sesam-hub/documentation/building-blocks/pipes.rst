...
A :ref:`scheduler <scheduling_and_signalling>` handles the mechanics of :ref:`pumping <pump_section>` data from a source to a sink. It runs periodically or on a :ref:`cron <cron-expressions>` schedule and reads entities from a source and writes them to a sink.
