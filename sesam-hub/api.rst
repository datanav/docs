...
See :ref:`the config groups API <api_config_groups>` for more information.


Metrics endpoint
================

If Monitoring and Metrics is enabled, you can access subscription and pipe metrics in the :ref:`Prometheus-compatible metrics API <metrics-api>` endpoint from your external monitoring tools.
