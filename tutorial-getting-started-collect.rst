...
To add HubSpot as a system, you must complete the following:

.. admonition:: Prerequisites

  Before adding HubSpot you must...
    
    - Create a `HubSpot App Developer Account <https://developers.hubspot.com/get-started>`_ in order to connect to the HubSpot API.
  	- Create an App Test Account. You will need this to interact with the HubSpot API. 
  	- Navigate to your settings section and pick the "Integrations" -> "API Key" tab.
  	- Create and save your API Key.

Having completed the above prerequisites, you can now move on and follow the below steps again to add HubSpot as a system, keep in mind the last step, which is needed for us to add our system secret.
...
Having completed the Collect tutorial, you are now ready to move onto the Enrich tutorial. 
