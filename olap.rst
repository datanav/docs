...
------------------
This micro service use the Power BI API to make a Sesam sink that write data directly to a Power BI datset.
...
------------------
Use standard Sesam SQL connectors. For Power BI, a "Azure SQL" database with the Sesam "microsoft-azure-sql-data-warehouse-system" is a good choice.
...
https://docs.sesam.io/configuration.html#the-microsoft-azure-sql-data-warehouse-system
    PRO: Relatively easy to set up. Works well with Power BI and other reporting tools. Affordable. Handles relatively large datasets. Works well with Power query.
