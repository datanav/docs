...
The updated data within Sesam Data Hub is not only consumable by analytical components in the data platform, but can also be synchronized back to relevant source systems to ensure data consistency across the whole platform.
