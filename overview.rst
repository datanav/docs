...
If you want to jump straight into Sesam and get hands-on, you can go right to the `labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__. 
...
Check out the lab
=================
The `Labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__  helps us get more hands on with Sesam. Head over there and do the first two labs to get more experience transforming data. 
...
Labs 3
^^^^^^
Go to the `Labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__ and do Lab 3.
...
Lab 4
^^^^^
Go to the `Labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__ and do Lab 4.
...
Lab 5
^^^^^
Go to the `Labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__ and do Lab 5.
...
Lab 6
^^^^^
Go to the `Labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__ and do Lab 6.
...
Lab 7
^^^^^
Go to the `Labs page <https://github.com/sesam-community/wiki/wiki/Labs>`__ and do Lab 7.
