...
exclude_patterns = ['_build', '.python_env', os.path.basename(os.environ['VIRTUAL_ENV'])]
...
# documentation.
html_theme_options = {
    "footer_items": ["left-sidebar-bottom.html"],
    "footer_center": ["copyright.html"],
    "footer_end": ["iso.html"],
    "navbar_end": "search-button",
    "navbar_persistent": "right-menu.html",
    'navigation_depth': 5,
...
#html_use_opensearch = 'http://localhost'
