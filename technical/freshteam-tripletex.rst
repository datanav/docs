...
Freshteam Employee to Tripletex Country
---------------------------------------
Before any synchronization can take place, a link between a Freshteam Employee and a Tripletex Country must be established.

A Freshteam Employee will merge with a Tripletex Country if one of the following property combinations match:
...
Once a link between a Freshteam Employee and a Tripletex Country is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Freshteam Employee and a Tripletex Country:
