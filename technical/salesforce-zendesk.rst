...
Salesforce Invoice to Zendesk Organizations
-------------------------------------------
Every Salesforce Invoice will be synchronized with a Zendesk Organizations.

Once a link between a Salesforce Invoice and a Zendesk Organizations is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Salesforce Invoice and a Zendesk Organizations:
