...
A new Wave Customer person will be created from a Tripletex Customer if it is connected to a Tripletex Order, Invoice, or Orderline that is synchronized into Wave.
