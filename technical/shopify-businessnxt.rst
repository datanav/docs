...
Shopify Customer to  Address
----------------------------
Every Shopify Customer will be synchronized with a  Address.

Once a link between a Shopify Customer and a  Address is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Shopify Customer and a  Address:
