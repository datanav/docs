...
Salesforce Contact to  Companycategories
----------------------------------------
Every Salesforce Contact will be synchronized with a  Companycategories.

Once a link between a Salesforce Contact and a  Companycategories is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Salesforce Contact and a  Companycategories:
