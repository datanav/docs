...
Salesforce Seller to Hubspot Lineitem
-------------------------------------
Every Salesforce Seller will be synchronized with a Hubspot Lineitem.

Once a link between a Salesforce Seller and a Hubspot Lineitem is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Salesforce Seller and a Hubspot Lineitem:
