...
Freshteam Employee to HubSpot Owner
-----------------------------------
Before any synchronization can take place, a link between a Freshteam Employee and a HubSpot Owner must be established.

A Freshteam Employee will merge with a HubSpot Owner if one of the following property combinations match:
...
Once a link between a Freshteam Employee and a HubSpot Owner is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Freshteam Employee and a HubSpot Owner:
