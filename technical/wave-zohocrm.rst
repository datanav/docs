...
-------------------------
Every Wave Customer will be synchronized with a  Account.

Once a link between a Wave Customer and a  Account is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Wave Customer and a  Account:
