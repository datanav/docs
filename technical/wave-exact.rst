...
Wave Currency to  Employees
---------------------------
Every Wave Currency will be synchronized with a  Employees.

Once a link between a Wave Currency and a  Employees is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Wave Currency and a  Employees:
