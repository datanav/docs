...
Chargebee Business_entity to Salesforce Currencytype
----------------------------------------------------
Every Chargebee Business_entity will be synchronized with a Salesforce Currencytype.

Once a link between a Chargebee Business_entity and a Salesforce Currencytype is established, it will keep in sync between the two systems, regardless of where it is edited.

The following properties are synchronized between a Chargebee Business_entity and a Salesforce Currencytype:
