...
-----------------------------------------
Before any synchronization can take place, a link between a Exact Online Items and a WooCommerce Product must be established.

A new WooCommerce Product will be created from a Exact Online Items if it is connected to a Exact Online Exact-salesorders that is synchronized into WooCommerce.
...
---------------------------------------------
Before any synchronization can take place, a link between a Exact Online Salesorders and a WooCommerce Order must be established.

A new WooCommerce Order will be created from a Exact Online Salesorders if it is connected to a Exact Online Exact-salesorders that is synchronized into WooCommerce.
