...
A new Superoffice Quotealternative will be created from a Salesforce Order if it is connected to a Salesforce Orderitem, Invoiceline, or Quotelineitem that is synchronized into Superoffice.
